...
namespace Telluria.Utils.Crud.Handlers
{
    ...
    public interface ICommandHandler<in TCommand, TResultData> : ICommandHandler where TCommand : ICommand
    {
    ...
    public interface IListCommandHandler<in TCommand, TResultData> : ICommandHandler where TCommand : IListCommand
    {
